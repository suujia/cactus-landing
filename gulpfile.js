...
const PATHS = {
  ...
  JS: {
    ...
    PLUGINS: ['js/plugins/all.min.js','js/plugins/imagesloaded.pkgd.js', 'js/plugins/TweenMax.js', 'js/plugins/ScrollToPlugin.js', 'js/plugins/CustomEase.js'],
  },
  SCSS: {
    ALL: 'scss/**/*.scss',
  ...
  DEPENDENCIES: {
    ...
    plyr: {
      FROM: ['node_modules/plyr/dist/plyr.min.js',"node_modules/plyr/dist/plyr.css"],
      TO: lib,
    },
    'owl-carousel': {
