...
function initMap() {
  ...
  if ($googlemaps.length) {
    ...
    $googlemaps.each((index, value) => {
      const $googlemap = $(value);
      const latLng = $googlemap.data('latlng')
        .split(',');
      ...
      if ($googlemap.data('theme') === 'streetview') {
        ...
        return new google.maps.StreetViewPanorama(mapElement, mapOptions);
      }
